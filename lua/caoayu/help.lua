...
function M.func(input,seg,env)
    if input == "/help" then
        ...
        yield(Candidate("help", seg.start, seg._end, rime_api.get_distribution_code_name(), "名称"))
        yield(Candidate("help", seg.start, seg._end, rime_api.get_distribution_version(), "发布版本号"))
		...
		yield(Candidate("help", seg.start, seg._end, "/fs/sz/lm/lmd", "分数/数字/罗马"))
		yield(Candidate("help", seg.start, seg._end, "/sj/yf/rq/yr", "时间/月份/日期"))
		yield(Candidate("help", seg.start, seg._end, "/fh/mj/dn/sz/pk", "符号/麻将/电脑/色子/扑克"))
